    ...
    >
      ...
      <motion.div 
        ...
        animate={{ 
          ...
          borderColor: isComplete ? "rgba(52, 211, 153, 0.4)" : "rgba(255, 255, 255, 0.12)"
        }}
        ...
        style={{
          boxShadow: isComplete ? "inset 0 0 50px rgba(52, 211, 153, 0.12)" : "inset 0 0 20px rgba(255, 255, 255, 0.02)"
        }}
      >
